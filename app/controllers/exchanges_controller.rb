...
class ExchangesController < ApplicationController
  ...
  before_filter :find_exchange, only: [:show, :edit, :update, :destroy, :follow, :unfollow, :favorite, :unfavorite, :hide, :unhide, :search_posts, :mark_as_read, :invite_participant, :remove_participant]
