...
ActiveRecord::Schema.define(version: 2020_01_31_230216) do
  ...
  create_table "social_service_links", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "social_service_id"
    t.string "username"
    t.string "url"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["social_service_id"], name: "index_social_service_links_on_social_service_id"
    t.index ["user_id"], name: "index_social_service_links_on_user_id"
  end

  create_table "social_services", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "label", default: "Username"
    t.string "url_pattern"
    t.boolean "custom_url", default: false, null: false
    t.boolean "enabled", default: true, null: false
    t.index ["name"], name: "index_social_services_on_name"
  end
